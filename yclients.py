...
class YClients:
    ...
    def __prepare_services(self, services:list, categories:dict) -> list:
        for service in services:
            categories[service['category_id']]['services'].append({"title": service['title'], "price": service['price_max'] or service['price_min'], "seance_length": service['seance_length'], "id": service['id']})
